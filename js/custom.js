...
$(window).on('load', function () {
    function createRecipeHTML(recipe) {
        return `
        <div class="col-sm-6 col-lg-4 all canh">
        <div class="box">
        <div>
        <div class="img-box">
        <img src="https://cdn.tgdd.vn/2021/04/CookProduct/caingotthitbamthumb-1200x676-1200x676.jpg" alt="">
        </div>
